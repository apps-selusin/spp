 ...
 * Page class
 */
class t0202_siswaiuran_list extends t0202_siswaiuran
{
	...
	// Page object name
	public $PageObjName = "t0202_siswaiuran_list";

	// Grid form hidden field names
	public $FormName = "ft0202_siswaiuranlist";
	...
	public function __construct()
	{
		...
		$this->MultiDeleteUrl = "t0202_siswaiurandelete.php";
		$this->MultiUpdateUrl = "t0202_siswaiuranupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft0202_siswaiuranlistsrch";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft0202_siswaiuranlistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft0202_siswaiuranlistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ft0202_siswaiuranlist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
