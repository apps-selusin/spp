 ...
 * Page class
 */
class t0302_bayardetail_list extends t0302_bayardetail
{
	...
	// Page object name
	public $PageObjName = "t0302_bayardetail_list";

	// Grid form hidden field names
	public $FormName = "ft0302_bayardetaillist";
	...
	public function __construct()
	{
		...
		$this->MultiDeleteUrl = "t0302_bayardetaildelete.php";
		$this->MultiUpdateUrl = "t0302_bayardetailupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft0302_bayardetaillistsrch";
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ft0302_bayardetaillist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
