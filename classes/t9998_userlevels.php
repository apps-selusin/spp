...
/**
 * Table class for t9998_userlevels
 */
class t9998_userlevels extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't9998_userlevels';
		$this->TableName = 't9998_userlevels';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t9998_userlevels`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new DbField('t9998_userlevels', 't9998_userlevels', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// userlevelname
		$this->userlevelname = new DbField('t9998_userlevels', 't9998_userlevels', 'x_userlevelname', 'userlevelname', '`userlevelname`', '`userlevelname`', 200, -1, FALSE, '`userlevelname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`t9998_userlevels`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t9998_userlevelslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "t9998_userlevelsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "t9998_userlevelsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t9998_userlevelsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("t9998_userlevelsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t9998_userlevelsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "t9998_userlevelsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t9998_userlevelsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t9998_userlevelsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t9998_userlevelsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t9998_userlevelsdelete.php", $this->getUrlParm());
	}
