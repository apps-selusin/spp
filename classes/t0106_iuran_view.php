 ...
 * Page class
 */
class t0106_iuran_view extends t0106_iuran
{
	...
	// Page object name
	public $PageObjName = "t0106_iuran_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t0106_iuranlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t0106_iuranlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t0106_iuranlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
