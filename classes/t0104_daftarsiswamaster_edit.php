 ...
 * Page class
 */
class t0104_daftarsiswamaster_edit extends t0104_daftarsiswamaster
{
	...
	// Page object name
	public $PageObjName = "t0104_daftarsiswamaster_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("t0105_daftarsiswadetail", $detailTblVar) && $GLOBALS["t0105_daftarsiswadetail"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("t0105_daftarsiswadetail", $detailTblVar) && $GLOBALS["t0105_daftarsiswadetail"]->DetailEdit) {
						...
						$editRow = $GLOBALS["t0105_daftarsiswadetail_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar <> "") {
			...
			if (in_array("t0105_daftarsiswadetail", $detailTblVar)) {
				...
				if ($GLOBALS["t0105_daftarsiswadetail_grid"]->DetailEdit) {
					$GLOBALS["t0105_daftarsiswadetail_grid"]->CurrentMode = "edit";
					$GLOBALS["t0105_daftarsiswadetail_grid"]->CurrentAction = "gridedit";
