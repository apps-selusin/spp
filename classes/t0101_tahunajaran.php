...
/**
 * Table class for t0101_tahunajaran
 */
class t0101_tahunajaran extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't0101_tahunajaran';
		$this->TableName = 't0101_tahunajaran';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t0101_tahunajaran`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('t0101_tahunajaran', 't0101_tahunajaran', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// AwalBulan
		$this->AwalBulan = new DbField('t0101_tahunajaran', 't0101_tahunajaran', 'x_AwalBulan', 'AwalBulan', '`AwalBulan`', '`AwalBulan`', 16, -1, FALSE, '`AwalBulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AwalBulan->Nullable = FALSE; // NOT NULL field
		$this->AwalBulan->Required = TRUE; // Required field
		$this->AwalBulan->Sortable = TRUE; // Allow sort
		$this->AwalBulan->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['AwalBulan'] = &$this->AwalBulan;

		// AwalTahun
		$this->AwalTahun = new DbField('t0101_tahunajaran', 't0101_tahunajaran', 'x_AwalTahun', 'AwalTahun', '`AwalTahun`', '`AwalTahun`', 2, -1, FALSE, '`AwalTahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AwalTahun->Nullable = FALSE; // NOT NULL field
		$this->AwalTahun->Required = TRUE; // Required field
		$this->AwalTahun->Sortable = TRUE; // Allow sort
		$this->AwalTahun->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['AwalTahun'] = &$this->AwalTahun;

		// AkhirBulan
		$this->AkhirBulan = new DbField('t0101_tahunajaran', 't0101_tahunajaran', 'x_AkhirBulan', 'AkhirBulan', '`AkhirBulan`', '`AkhirBulan`', 16, -1, FALSE, '`AkhirBulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AkhirBulan->Nullable = FALSE; // NOT NULL field
		$this->AkhirBulan->Required = TRUE; // Required field
		$this->AkhirBulan->Sortable = TRUE; // Allow sort
		$this->AkhirBulan->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['AkhirBulan'] = &$this->AkhirBulan;

		// AkhirTahun
		$this->AkhirTahun = new DbField('t0101_tahunajaran', 't0101_tahunajaran', 'x_AkhirTahun', 'AkhirTahun', '`AkhirTahun`', '`AkhirTahun`', 2, -1, FALSE, '`AkhirTahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AkhirTahun->Nullable = FALSE; // NOT NULL field
		$this->AkhirTahun->Required = TRUE; // Required field
		$this->AkhirTahun->Sortable = TRUE; // Allow sort
		$this->AkhirTahun->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['AkhirTahun'] = &$this->AkhirTahun;

		// TahunAjaran
		$this->TahunAjaran = new DbField('t0101_tahunajaran', 't0101_tahunajaran', 'x_TahunAjaran', 'TahunAjaran', '`TahunAjaran`', '`TahunAjaran`', 200, -1, FALSE, '`TahunAjaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TahunAjaran->Nullable = FALSE; // NOT NULL field
		$this->TahunAjaran->Required = TRUE; // Required field
		$this->TahunAjaran->Sortable = TRUE; // Allow sort
		$this->fields['TahunAjaran'] = &$this->TahunAjaran;

		// Aktif
		$this->Aktif = new DbField('t0101_tahunajaran', 't0101_tahunajaran', 'x_Aktif', 'Aktif', '`Aktif`', '`Aktif`', 202, -1, FALSE, '`Aktif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->Aktif->Nullable = FALSE; // NOT NULL field
		$this->Aktif->Required = TRUE; // Required field
		$this->Aktif->Sortable = TRUE; // Allow sort
		$this->Aktif->Lookup = new Lookup('Aktif', 't0101_tahunajaran', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`t0101_tahunajaran`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t0101_tahunajaranlist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "t0101_tahunajaranedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t0101_tahunajaranadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("t0101_tahunajaranview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t0101_tahunajaranview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "t0101_tahunajaranadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t0101_tahunajaranadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t0101_tahunajaranedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t0101_tahunajaranadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t0101_tahunajarandelete.php", $this->getUrlParm());
	}
	...
	public function renderEditRow()
	{
		...
		$this->AwalBulan->EditValue = $this->AwalBulan->CurrentValue;
		...
		$this->AkhirBulan->EditValue = $this->AkhirBulan->CurrentValue;
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					$doc->exportCaption($this->AwalBulan);
					$doc->exportCaption($this->AwalTahun);
					$doc->exportCaption($this->AkhirBulan);
					$doc->exportCaption($this->AkhirTahun);
		...
		while (!$recordset->EOF && $recCnt < $stopRec) {
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						$doc->exportField($this->AwalBulan);
						$doc->exportField($this->AwalTahun);
						$doc->exportField($this->AkhirBulan);
						$doc->exportField($this->AkhirTahun);
