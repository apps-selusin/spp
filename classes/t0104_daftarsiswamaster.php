...
/**
 * Table class for t0104_daftarsiswamaster
 */
class t0104_daftarsiswamaster extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't0104_daftarsiswamaster';
		$this->TableName = 't0104_daftarsiswamaster';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t0104_daftarsiswamaster`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('t0104_daftarsiswamaster', 't0104_daftarsiswamaster', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// tahunajaran_id
		$this->tahunajaran_id = new DbField('t0104_daftarsiswamaster', 't0104_daftarsiswamaster', 'x_tahunajaran_id', 'tahunajaran_id', '`tahunajaran_id`', '`tahunajaran_id`', 3, -1, FALSE, '`tahunajaran_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// sekolah_id
		$this->sekolah_id = new DbField('t0104_daftarsiswamaster', 't0104_daftarsiswamaster', 'x_sekolah_id', 'sekolah_id', '`sekolah_id`', '`sekolah_id`', 3, -1, FALSE, '`sekolah_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->sekolah_id->Lookup = new Lookup('sekolah_id', 't0102_sekolah', FALSE, 'id', ["Sekolah","","",""], [], [], [], [], [], [], '', '');
		$this->sekolah_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['sekolah_id'] = &$this->sekolah_id;

		// kelas_id
		$this->kelas_id = new DbField('t0104_daftarsiswamaster', 't0104_daftarsiswamaster', 'x_kelas_id', 'kelas_id', '`kelas_id`', '`kelas_id`', 3, -1, FALSE, '`kelas_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->kelas_id->Lookup = new Lookup('kelas_id', 't0103_kelas', FALSE, 'id', ["Kelas","","",""], [], [], [], [], [], [], '', '');
	...
	public function getDetailUrl()
	{
		...
		// Detail url
		$detailUrl = "";
		if ($this->getCurrentDetailTable() == "t0105_daftarsiswadetail") {
			$detailUrl = $GLOBALS["t0105_daftarsiswadetail"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "t0104_daftarsiswamasterlist.php";
		return $detailUrl;
	}
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`t0104_daftarsiswamaster`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t0104_daftarsiswamasterlist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "t0104_daftarsiswamasteredit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t0104_daftarsiswamasteradd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("t0104_daftarsiswamasterview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t0104_daftarsiswamasterview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "t0104_daftarsiswamasteradd.php?" . $this->getUrlParm($parm);
		else
			$url = "t0104_daftarsiswamasteradd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("t0104_daftarsiswamasteredit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t0104_daftarsiswamasteredit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("t0104_daftarsiswamasteradd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t0104_daftarsiswamasteradd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t0104_daftarsiswamasterdelete.php", $this->getUrlParm());
	}
