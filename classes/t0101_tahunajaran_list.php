 ...
 * Page class
 */
class t0101_tahunajaran_list extends t0101_tahunajaran
{
	...
	// Page object name
	public $PageObjName = "t0101_tahunajaran_list";

	// Grid form hidden field names
	public $FormName = "ft0101_tahunajaranlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "t0101_tahunajaranadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "t0101_tahunajarandelete.php";
		$this->MultiUpdateUrl = "t0101_tahunajaranupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft0101_tahunajaranlistsrch";
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->AwalBulan, $ctrl); // AwalBulan
			$this->updateSort($this->AwalTahun, $ctrl); // AwalTahun
			$this->updateSort($this->AkhirBulan, $ctrl); // AkhirBulan
			$this->updateSort($this->AkhirTahun, $ctrl); // AkhirTahun
	...
	protected function resetCmd()
	{
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				$orderBy = "";
				$this->setSessionOrderBy($orderBy);
				$this->AwalBulan->setSort("");
				$this->AwalTahun->setSort("");
				$this->AkhirBulan->setSort("");
				$this->AkhirTahun->setSort("");
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft0101_tahunajaranlistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft0101_tahunajaranlistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ft0101_tahunajaranlist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
