 ...
 * Page class
 */
class t0302_bayardetail_delete extends t0302_bayardetail
{
	...
	// Page object name
	public $PageObjName = "t0302_bayardetail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t0302_bayardetaillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t0302_bayardetaillist.php"); // Return to list
			}
		}
	}
