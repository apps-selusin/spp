...
/**
 * Table class for t9997_userlevelpermissions
 */
class t9997_userlevelpermissions extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't9997_userlevelpermissions';
		$this->TableName = 't9997_userlevelpermissions';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t9997_userlevelpermissions`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new DbField('t9997_userlevelpermissions', 't9997_userlevelpermissions', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tablename
		$this->_tablename = new DbField('t9997_userlevelpermissions', 't9997_userlevelpermissions', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// permission
		$this->permission = new DbField('t9997_userlevelpermissions', 't9997_userlevelpermissions', 'x_permission', 'permission', '`permission`', '`permission`', 3, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`t9997_userlevelpermissions`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t9997_userlevelpermissionslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "t9997_userlevelpermissionsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "t9997_userlevelpermissionsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t9997_userlevelpermissionsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("t9997_userlevelpermissionsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t9997_userlevelpermissionsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "t9997_userlevelpermissionsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t9997_userlevelpermissionsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t9997_userlevelpermissionsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t9997_userlevelpermissionsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t9997_userlevelpermissionsdelete.php", $this->getUrlParm());
	}
	...
	{
		$table = 't9997_userlevelpermissions';
		$usr = CurrentUserID();
