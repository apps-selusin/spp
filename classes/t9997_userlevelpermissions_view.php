 ...
 * Page class
 */
class t9997_userlevelpermissions_view extends t9997_userlevelpermissions
{
	...
	// Page object name
	public $PageObjName = "t9997_userlevelpermissions_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("t9997_userlevelpermissionslist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("userlevelid") !== NULL) {
				...
				$returnUrl = "t9997_userlevelpermissionslist.php"; // Return to list
			}
			if (Get("_tablename") !== NULL) {
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t9997_userlevelpermissionslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t9997_userlevelpermissionslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t9997_userlevelpermissionslist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
