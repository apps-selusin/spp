 ...
 * Page class
 */
class t0106_iuran_edit extends t0106_iuran
{
	...
	// Page object name
	public $PageObjName = "t0106_iuran_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Iuran
			$this->Iuran->setDbValueDef($rsnew, $this->Iuran->CurrentValue, "", $this->Iuran->ReadOnly);
