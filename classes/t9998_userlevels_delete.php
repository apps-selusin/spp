 ...
 * Page class
 */
class t9998_userlevels_delete extends t9998_userlevels
{
	...
	// Page object name
	public $PageObjName = "t9998_userlevels_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t9998_userlevelslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t9998_userlevelslist.php"); // Return to list
			}
		}
	}
