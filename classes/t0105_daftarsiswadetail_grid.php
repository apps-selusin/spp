 ...
 * Page class
 */
class t0105_daftarsiswadetail_grid extends t0105_daftarsiswadetail
{
	...
	// Page object name
	public $PageObjName = "t0105_daftarsiswadetail_grid";

	// Grid form hidden field names
	public $FormName = "ft0105_daftarsiswadetailgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "t0104_daftarsiswamaster") {
			$this->daftarsiswamaster_id->Visible = FALSE;
			if ($GLOBALS["t0104_daftarsiswamaster"]->EventCancelled)
