 ...
 * Page class
 */
class t0101_tahunajaran_view extends t0101_tahunajaran
{
	...
	// Page object name
	public $PageObjName = "t0101_tahunajaran_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t0101_tahunajaranlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t0101_tahunajaranlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t0101_tahunajaranlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
