 ...
 * Page class
 */
class userpriv extends t9998_userlevels
{
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["t9998_userlevels"]))
			$GLOBALS["t9998_userlevels"] = &$this;
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 't9998_userlevels');
			if ($Security->isLoggedIn())
		...
		$Breadcrumb->add("list", "t9998_userlevels", "t9998_userlevelslist.php", "", "t9998_userlevels");
