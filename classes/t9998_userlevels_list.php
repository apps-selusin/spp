 ...
 * Page class
 */
class t9998_userlevels_list extends t9998_userlevels
{
	...
	// Table name
	public $TableName = 't9998_userlevels';

	// Page object name
	public $PageObjName = "t9998_userlevels_list";

	// Grid form hidden field names
	public $FormName = "ft9998_userlevelslist";
	...
	public function __construct()
	{
		...
		// Table object (t9998_userlevels)
		if (!isset($GLOBALS["t9998_userlevels"]) || get_class($GLOBALS["t9998_userlevels"]) == PROJECT_NAMESPACE . "t9998_userlevels") {
			$GLOBALS["t9998_userlevels"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["t9998_userlevels"];
		}
		...
		$this->AddUrl = "t9998_userlevelsadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "t9998_userlevelsdelete.php";
		$this->MultiUpdateUrl = "t9998_userlevelsupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 't9998_userlevels');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft9998_userlevelslistsrch";
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $EXPORT, $t9998_userlevels;
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, $EXPORT)) {
			...
			if (class_exists($class)) {
				$doc = new $class($t9998_userlevels);
				$doc->Text = @$content;
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ft9998_userlevelslistsrch", $filters);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft9998_userlevelslistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft9998_userlevelslistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ft9998_userlevelslist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ft9998_userlevelslistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
