...
/**
 * Table class for r0305_potensi
 */
class r0305_potensi extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'r0305_potensi';
		$this->TableName = 'r0305_potensi';
		...
		// iuran
		$this->iuran = new ReportField('r0305_potensi', 'r0305_potensi', 'x_iuran', 'iuran', '`iuran`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->iuran->Lookup = new ReportLookup('iuran', 'r0305_potensi', TRUE, 'iuran', ["iuran","","",""], [], [], [], [], [], [], '`iuran` ASC', '');
		$this->iuran->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['iuran'] = &$this->iuran;

		// jenis
		$this->jenis = new ReportField('r0305_potensi', 'r0305_potensi', 'x_jenis', 'jenis', '`jenis`', 202, -1, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->jenis->Sortable = TRUE; // Allow sort
		$this->jenis->DateFilter = "";
		$this->fields['jenis'] = &$this->jenis;

		// tahunajaran
		$this->tahunajaran = new ReportField('r0305_potensi', 'r0305_potensi', 'x_tahunajaran', 'tahunajaran', '`tahunajaran`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->tahunajaran->Lookup = new ReportLookup('tahunajaran', 'r0305_potensi', TRUE, 'tahunajaran', ["tahunajaran","","",""], [], [], [], [], [], [], '`tahunajaran` ASC', '');
		$this->tahunajaran->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['tahunajaran'] = &$this->tahunajaran;

		// sekolah
		$this->sekolah = new ReportField('r0305_potensi', 'r0305_potensi', 'x_sekolah', 'sekolah', '`sekolah`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->sekolah->Lookup = new ReportLookup('sekolah', 'r0305_potensi', TRUE, 'sekolah', ["sekolah","","",""], [], [], [], [], [], [], '`sekolah` ASC', '');
		$this->sekolah->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['sekolah'] = &$this->sekolah;

		// kelas
		$this->kelas = new ReportField('r0305_potensi', 'r0305_potensi', 'x_kelas', 'kelas', '`kelas`', 200, -1, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->kelas->Lookup = new ReportLookup('kelas', 'r0305_potensi', TRUE, 'kelas', ["kelas","","",""], [], [], [], [], [], [], '`kelas` ASC', '');
		$this->kelas->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['kelas'] = &$this->kelas;

		// potensi
		$this->potensi = new ReportField('r0305_potensi', 'r0305_potensi', 'x_potensi', 'potensi', '`potensi`', 5, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// terbayar
		$this->terbayar = new ReportField('r0305_potensi', 'r0305_potensi', 'x_terbayar', 'terbayar', '`terbayar`', 5, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sisa
		$this->sisa = new ReportField('r0305_potensi', 'r0305_potensi', 'x_sisa', 'sisa', '`sisa`', 5, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlSelectAggregate <> "") ? $this->_sqlSelectAggregate : "SELECT SUM(`sisa`) AS `sum_sisa` FROM " . $this->getSqlFrom();
	}
