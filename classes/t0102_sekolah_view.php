 ...
 * Page class
 */
class t0102_sekolah_view extends t0102_sekolah
{
	...
	// Page object name
	public $PageObjName = "t0102_sekolah_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t0102_sekolahlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t0102_sekolahlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t0102_sekolahlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
