...
/**
 * Table class for r0303_potensi
 */
class r0303_potensi extends ReportTable
{
	...
	public function __construct()
	{
		...
		$this->TableVar = 'r0303_potensi';
		$this->TableName = 'r0303_potensi';
		...
		// tahunajaran
		$this->tahunajaran = new ReportField('r0303_potensi', 'r0303_potensi', 'x_tahunajaran', 'tahunajaran', '`tahunajaran`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tahunajaran->Sortable = TRUE; // Allow sort
		$this->tahunajaran->DateFilter = "";
		$this->fields['tahunajaran'] = &$this->tahunajaran;

		// sekolah
		$this->sekolah = new ReportField('r0303_potensi', 'r0303_potensi', 'x_sekolah', 'sekolah', '`sekolah`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sekolah->Sortable = TRUE; // Allow sort
		$this->sekolah->DateFilter = "";
		$this->fields['sekolah'] = &$this->sekolah;

		// kelas
		$this->kelas = new ReportField('r0303_potensi', 'r0303_potensi', 'x_kelas', 'kelas', '`kelas`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kelas->Sortable = TRUE; // Allow sort
		$this->kelas->DateFilter = "";
		$this->fields['kelas'] = &$this->kelas;

		// nis
		$this->nis = new ReportField('r0303_potensi', 'r0303_potensi', 'x_nis', 'nis', '`nis`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nis->Sortable = TRUE; // Allow sort
		$this->nis->DateFilter = "";
		$this->fields['nis'] = &$this->nis;

		// nama
		$this->nama = new ReportField('r0303_potensi', 'r0303_potensi', 'x_nama', 'nama', '`nama`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama->Sortable = TRUE; // Allow sort
		$this->nama->DateFilter = "";
		$this->fields['nama'] = &$this->nama;

		// jumlah
		$this->jumlah = new ReportField('r0303_potensi', 'r0303_potensi', 'x_jumlah', 'jumlah', '`jumlah`', 5, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// terbayar
		$this->terbayar = new ReportField('r0303_potensi', 'r0303_potensi', 'x_terbayar', 'terbayar', '`terbayar`', 5, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sisa
		$this->sisa = new ReportField('r0303_potensi', 'r0303_potensi', 'x_sisa', 'sisa', '`sisa`', 5, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->_sqlFrom <> "") ? $this->_sqlFrom : "`v0303_potensi`";
	}
