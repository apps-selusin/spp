 ...
 * Page class
 */
class t0105_daftarsiswadetail_view extends t0105_daftarsiswadetail
{
	...
	// Page object name
	public $PageObjName = "t0105_daftarsiswadetail_view";
	...
	public function run()
	{
		...
		$this->id->Visible = FALSE;
		$this->daftarsiswamaster_id->setVisibility();
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t0105_daftarsiswadetaillist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t0105_daftarsiswadetaillist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t0105_daftarsiswadetaillist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
