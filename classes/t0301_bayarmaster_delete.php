 ...
 * Page class
 */
class t0301_bayarmaster_delete extends t0301_bayarmaster
{
	...
	// Page object name
	public $PageObjName = "t0301_bayarmaster_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t0301_bayarmasterlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t0301_bayarmasterlist.php"); // Return to list
			}
		}
	}
