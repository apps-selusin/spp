 ...
 * Page class
 */
class t9997_userlevelpermissions_add extends t9997_userlevelpermissions
{
	...
	// Page object name
	public $PageObjName = "t9997_userlevelpermissions_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("t9997_userlevelpermissionslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "t9997_userlevelpermissionslist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "t9997_userlevelpermissionsview.php")
