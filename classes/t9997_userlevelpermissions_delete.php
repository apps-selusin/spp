 ...
 * Page class
 */
class t9997_userlevelpermissions_delete extends t9997_userlevelpermissions
{
	...
	// Page object name
	public $PageObjName = "t9997_userlevelpermissions_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t9997_userlevelpermissionslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t9997_userlevelpermissionslist.php"); // Return to list
			}
		}
	}
