 ...
 * Page class
 */
class t0105_daftarsiswadetail_delete extends t0105_daftarsiswadetail
{
	...
	// Page object name
	public $PageObjName = "t0105_daftarsiswadetail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t0105_daftarsiswadetaillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t0105_daftarsiswadetaillist.php"); // Return to list
			}
		}
	}
