 ...
 * Page class
 */
class t0101_tahunajaran_delete extends t0101_tahunajaran
{
	...
	// Page object name
	public $PageObjName = "t0101_tahunajaran_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t0101_tahunajaranlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t0101_tahunajaranlist.php"); // Return to list
			}
		}
	}
