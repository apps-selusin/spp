<?php
namespace PHPReportMaker12\spp_prj;
...
class rptindex
{
	...
	public function run()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'r0302_potensi'))
			$this->terminate("r0302_potensismry.php"); // Exit and go to default page
		if ($Security->isLoggedIn()) {
			$this->setFailureMessage(DeniedMessage() . "<br><br><a href=\"logout.php\">" . $ReportLanguage->phrase("BackToLogin") . "</a>");
		} else {
