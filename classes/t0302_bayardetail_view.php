 ...
 * Page class
 */
class t0302_bayardetail_view extends t0302_bayardetail
{
	...
	// Page object name
	public $PageObjName = "t0302_bayardetail_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t0302_bayardetaillist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t0302_bayardetaillist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t0302_bayardetaillist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
