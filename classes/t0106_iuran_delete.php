 ...
 * Page class
 */
class t0106_iuran_delete extends t0106_iuran
{
	...
	// Page object name
	public $PageObjName = "t0106_iuran_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t0106_iuranlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t0106_iuranlist.php"); // Return to list
			}
		}
	}
