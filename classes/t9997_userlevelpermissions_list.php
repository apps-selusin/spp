 ...
 * Page class
 */
class t9997_userlevelpermissions_list extends t9997_userlevelpermissions
{
	...
	// Table name
	public $TableName = 't9997_userlevelpermissions';

	// Page object name
	public $PageObjName = "t9997_userlevelpermissions_list";

	// Grid form hidden field names
	public $FormName = "ft9997_userlevelpermissionslist";
	...
	public function __construct()
	{
		...
		// Table object (t9997_userlevelpermissions)
		if (!isset($GLOBALS["t9997_userlevelpermissions"]) || get_class($GLOBALS["t9997_userlevelpermissions"]) == PROJECT_NAMESPACE . "t9997_userlevelpermissions") {
			$GLOBALS["t9997_userlevelpermissions"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["t9997_userlevelpermissions"];
		}
		...
		$this->AddUrl = "t9997_userlevelpermissionsadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "t9997_userlevelpermissionsdelete.php";
		$this->MultiUpdateUrl = "t9997_userlevelpermissionsupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 't9997_userlevelpermissions');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft9997_userlevelpermissionslistsrch";
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $EXPORT, $t9997_userlevelpermissions;
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, $EXPORT)) {
			...
			if (class_exists($class)) {
				$doc = new $class($t9997_userlevelpermissions);
				$doc->Text = @$content;
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ft9997_userlevelpermissionslistsrch", $filters);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft9997_userlevelpermissionslistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft9997_userlevelpermissionslistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ft9997_userlevelpermissionslist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ft9997_userlevelpermissionslistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
