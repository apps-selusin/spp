 ...
 * Page class
 */
class t9998_userlevels_view extends t9998_userlevels
{
	...
	// Page object name
	public $PageObjName = "t9998_userlevels_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("t9998_userlevelslist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("userlevelid") !== NULL) {
				...
				$returnUrl = "t9998_userlevelslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t9998_userlevelslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t9998_userlevelslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t9998_userlevelslist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
