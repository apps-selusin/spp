 ...
 * Page class
 */
class t0104_daftarsiswamaster_delete extends t0104_daftarsiswamaster
{
	...
	// Page object name
	public $PageObjName = "t0104_daftarsiswamaster_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t0104_daftarsiswamasterlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t0104_daftarsiswamasterlist.php"); // Return to list
			}
		}
	}
