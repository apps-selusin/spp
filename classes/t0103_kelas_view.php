 ...
 * Page class
 */
class t0103_kelas_view extends t0103_kelas
{
	...
	// Page object name
	public $PageObjName = "t0103_kelas_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("t0103_kelaslist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t0103_kelaslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t0103_kelaslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t0103_kelaslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t0103_kelaslist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
