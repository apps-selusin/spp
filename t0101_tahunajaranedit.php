...
// Create page object
$t0101_tahunajaran_edit = new t0101_tahunajaran_edit();

// Run the page
$t0101_tahunajaran_edit->run();
...
$t0101_tahunajaran_edit->Page_Render();
?>
...
var ft0101_tahunajaranedit = currentForm = new ew.Form("ft0101_tahunajaranedit", "edit");

// Validate form
ft0101_tahunajaranedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($t0101_tahunajaran_edit->AwalBulan->Required) { ?>
		...
		<?php if ($t0101_tahunajaran_edit->AwalTahun->Required) { ?>
		...
		<?php if ($t0101_tahunajaran_edit->AkhirBulan->Required) { ?>
		...
		<?php if ($t0101_tahunajaran_edit->AkhirTahun->Required) { ?>
		...
		<?php if ($t0101_tahunajaran_edit->TahunAjaran->Required) { ?>
		...
		<?php } ?>
		<?php if ($t0101_tahunajaran_edit->Aktif->Required) { ?>
...
ft0101_tahunajaranedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ft0101_tahunajaranedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ft0101_tahunajaranedit.lists["x_Aktif"] = <?php echo $t0101_tahunajaran_edit->Aktif->Lookup->toClientList() ?>;
ft0101_tahunajaranedit.lists["x_Aktif"].options = <?php echo JsonEncode($t0101_tahunajaran_edit->Aktif->options(FALSE, TRUE)) ?>;
...
<?php $t0101_tahunajaran_edit->showPageHeader(); ?>
<?php
$t0101_tahunajaran_edit->showMessage();
?>
<form name="ft0101_tahunajaranedit" id="ft0101_tahunajaranedit" class="<?php echo $t0101_tahunajaran_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($t0101_tahunajaran_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t0101_tahunajaran_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t0101_tahunajaran">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$t0101_tahunajaran_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($t0101_tahunajaran->AwalBulan->Visible) { // AwalBulan ?>
	<div id="r_AwalBulan" class="form-group row">
		<label id="elh_t0101_tahunajaran_AwalBulan" for="x_AwalBulan" class="<?php echo $t0101_tahunajaran_edit->LeftColumnClass ?>"><?php echo $t0101_tahunajaran->AwalBulan->caption() ?><?php echo ($t0101_tahunajaran->AwalBulan->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t0101_tahunajaran_edit->RightColumnClass ?>"><div<?php echo $t0101_tahunajaran->AwalBulan->cellAttributes() ?>>
...
<?php if ($t0101_tahunajaran->AwalTahun->Visible) { // AwalTahun ?>
	<div id="r_AwalTahun" class="form-group row">
		<label id="elh_t0101_tahunajaran_AwalTahun" for="x_AwalTahun" class="<?php echo $t0101_tahunajaran_edit->LeftColumnClass ?>"><?php echo $t0101_tahunajaran->AwalTahun->caption() ?><?php echo ($t0101_tahunajaran->AwalTahun->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t0101_tahunajaran_edit->RightColumnClass ?>"><div<?php echo $t0101_tahunajaran->AwalTahun->cellAttributes() ?>>
...
<?php if ($t0101_tahunajaran->AkhirBulan->Visible) { // AkhirBulan ?>
	<div id="r_AkhirBulan" class="form-group row">
		<label id="elh_t0101_tahunajaran_AkhirBulan" for="x_AkhirBulan" class="<?php echo $t0101_tahunajaran_edit->LeftColumnClass ?>"><?php echo $t0101_tahunajaran->AkhirBulan->caption() ?><?php echo ($t0101_tahunajaran->AkhirBulan->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t0101_tahunajaran_edit->RightColumnClass ?>"><div<?php echo $t0101_tahunajaran->AkhirBulan->cellAttributes() ?>>
...
<?php if ($t0101_tahunajaran->AkhirTahun->Visible) { // AkhirTahun ?>
	<div id="r_AkhirTahun" class="form-group row">
		<label id="elh_t0101_tahunajaran_AkhirTahun" for="x_AkhirTahun" class="<?php echo $t0101_tahunajaran_edit->LeftColumnClass ?>"><?php echo $t0101_tahunajaran->AkhirTahun->caption() ?><?php echo ($t0101_tahunajaran->AkhirTahun->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t0101_tahunajaran_edit->RightColumnClass ?>"><div<?php echo $t0101_tahunajaran->AkhirTahun->cellAttributes() ?>>
...
<?php if ($t0101_tahunajaran->TahunAjaran->Visible) { // TahunAjaran ?>
	<div id="r_TahunAjaran" class="form-group row">
		<label id="elh_t0101_tahunajaran_TahunAjaran" for="x_TahunAjaran" class="<?php echo $t0101_tahunajaran_edit->LeftColumnClass ?>"><?php echo $t0101_tahunajaran->TahunAjaran->caption() ?><?php echo ($t0101_tahunajaran->TahunAjaran->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t0101_tahunajaran_edit->RightColumnClass ?>"><div<?php echo $t0101_tahunajaran->TahunAjaran->cellAttributes() ?>>
...
<?php if ($t0101_tahunajaran->Aktif->Visible) { // Aktif ?>
	<div id="r_Aktif" class="form-group row">
		<label id="elh_t0101_tahunajaran_Aktif" class="<?php echo $t0101_tahunajaran_edit->LeftColumnClass ?>"><?php echo $t0101_tahunajaran->Aktif->caption() ?><?php echo ($t0101_tahunajaran->Aktif->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t0101_tahunajaran_edit->RightColumnClass ?>"><div<?php echo $t0101_tahunajaran->Aktif->cellAttributes() ?>>
...
<?php } ?>
	...
	<input type="hidden" data-table="t0101_tahunajaran" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($t0101_tahunajaran->id->CurrentValue) ?>">
<?php if (!$t0101_tahunajaran_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $t0101_tahunajaran_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $t0101_tahunajaran_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$t0101_tahunajaran_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$t0101_tahunajaran_edit->terminate();
?>