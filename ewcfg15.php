...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "spp_prj"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'tU4XA7vPZ91attz3'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/spp_prj.css"); // Project stylesheet file name
...
$PROJECT_ID = "{45A85772-754E-4F4B-A197-9291CE1FD3F9}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_spp", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "USER_LEVEL_TABLE", "`t9998_userlevels`");
...
define(PROJECT_NAMESPACE . "USER_LEVEL_PRIV_TABLE", "`t9997_userlevelpermissions`");
