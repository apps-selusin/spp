...
function CurrentProjectID() {
	...
	return "{45A85772-754E-4F4B-A197-9291CE1FD3F9}";
}
...
class AdvancedSecurity
{
	...
	public function setupUserLevelEx()
	{
		...
		if (count($this->UserLevelPriv) == 0 && $this->isAdmin() && $Page != NULL && @$_SESSION[SESSION_USER_LEVEL_MSG] == "") {
			...
			$Page->terminate("t9998_userlevelslist.php");
		}
		return TRUE;
	}
...
function Database_Connecting(&$info) {
	...
	} elseif (CurrentHost () == "spp.selusin.web.id") { // setting koneksi database untuk komputer server
